...
## Documentation
For additional documentation with images, please go to [Angelo Mandato's blog post about this AWS Console S3 Downloader](https://angelo.mandato.com/2025/03/06/s3-web-console-multi-file-downloader-bookmarklet/).
